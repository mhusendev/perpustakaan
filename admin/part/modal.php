    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <label>PIlih Absen (Masuk / Keluar)</label>
          <select class="form-control absen" name="absen" id="absen">
        ...
        <div class="modal-footer">
          <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
          <button class="btn btn-primary" type="button" data-dismiss="modal" id="tap">Absen</button>
        </div>
      </div>
    </div>
  </div>
