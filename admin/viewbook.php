    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <CENTER><h5  ><?php echo $_GET['judul']."(".$_GET['kategori'].")" ?>  </h5></CENTER>


          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <a href="slider.php" ><i class="fas fa-delete add"></i> Kembali</a>
              <h5 style="float: right;"><?php  echo " Penulis : ".$_GET['pengarang'];   ?></h5>
            </div>
            <div class="card-body">
     ...
     <?php
                    $n=1;
                    $sql=mysql_query("SELECT * FROM stok_buku where judul ='".mysql_real_escape_string($_GET['judul'])."' AND kategori='".mysql_real_escape_string($_GET['kategori'])."' ORDER BY id DESC");
             ...
             <div class="form-group">
                          ...
                          <select class="chosen-select judul" name="judul"  id="judul" style="width: 100%">
                               <option>Pilih Judul Buku</option>
                                <?php
                                $sql=mysql_query("SELECT id,judul FROM master_buku ORDER BY judul ASC");
                                while ($row=mysql_fetch_array($sql)) {
                                  echo '
      ...
      <div class="modal-content">
        ...
        <form action="modul/stokbuku_modul.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="modal-body">
            ...
            <div class="form-group text-input">
              <input type="text" class="form-control pengarang2" id="pengarang2" name="pengarang2" readonly>
            </div>
