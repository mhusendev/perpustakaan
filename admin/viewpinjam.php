...
<?php 
$sql=mysql_query("SELECT * From member where kduser='".mysql_real_escape_string($_GET['kduser'])."'");
...
?>
     ...
     <?php
                    $n=1;
                    $sql=mysql_query("SELECT b.judul,m.pengarang,p.kdpinjam,p.tglpinjam,p.tglpengembalian,p.id_user From peminjaman p JOIN stok_buku b ON p.kdbuku=b.isbn JOIN master_buku m ON b.judul=m.judul WHERE p.kduser ='".mysql_real_escape_string($_GET['kduser'])."'" );
